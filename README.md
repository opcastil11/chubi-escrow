...
[![Tests](https://img.shields.io/badge/tests-26%20unit%20%2B%2016%20integration-b6fe08?style=flat-square)](#development)
...
<tr><td><b>Account sizes</b></td><td>MarketState ~476 B · PositionState ~116 B</td></tr>
</table>
...
|---|---|---|---|
| 1 | `create_market` | Authority | Init market + vault PDAs |
...
| 5 | `claim_payout` | User | On-chain payout computation, SOL sent from vault |
...
├── state.rs          MarketState, PositionState
├── constants.rs      16 protocol constants (PRECISION = 1e6, FEE = 200 bps, …)
├── math.rs           pure math + 26 unit tests
...
- **Trustless vault PDA** — only the program can sign transfers out of it. The authority cannot drain user funds.
